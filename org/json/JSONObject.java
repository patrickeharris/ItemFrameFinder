...
public class JSONObject
{
  ...
  protected JSONObject(int initialCapacity) { this.map = new HashMap<>(initialCapacity); }
  ...
  public boolean isNull(String key) { return NULL.equals(opt(key)); }
  ...
  protected Set<Map.Entry<String, Object>> entrySet() { return this.map.entrySet(); }
  ...
  public <E extends Enum<E>> E optEnum(Class<E> clazz, String key) { return optEnum(clazz, key, null); }
  ...
  public double optDouble(String key) { return optDouble(key, NaND); }
  ...
  public float optFloat(String key) { return optFloat(key, NaNF); }
  ...
  public Number optNumber(String key) { return optNumber(key, null); }
    ...
    for (Method method : methods) {
      ...
      if (Modifier.isPublic(modifiers) && 
        ...
        if (key.length() > 0 && 
          ...
          try { Object result = method.invoke(bean, new Object[0]);
            if (result != null) {
  ...
  public static String valueToString(Object value) throws JSONException { return JSONWriter.valueToString(value); }
  ...
  public Writer write(Writer writer) throws JSONException { return write(writer, 0, 0); }
