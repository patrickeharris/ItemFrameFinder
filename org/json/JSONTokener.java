...
public class JSONTokener
{
  ...
  public JSONTokener(InputStream inputStream) { this(new InputStreamReader(inputStream)); }
      ...
      switch (c) {
        ...
        case '\\':
          ...
          switch (c) {
            ...
            case 'u':
              try {
                sb.append((char)Integer.parseInt(next(4), 16)); continue;
  ...
  public JSONException syntaxError(String message, Throwable causedBy) { return new JSONException(message + toString(), causedBy); }
