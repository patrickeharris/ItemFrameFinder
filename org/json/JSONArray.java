  ...
  implements Iterable<Object>
{
  ...
  public Iterator<Object> iterator() { return this.myArrayList.iterator(); }
  ...
  public Object opt(int index) { return (index < 0 || index >= length()) ? null : this.myArrayList
      .get(index); }
  ...
  public double optDouble(int index) { return optDouble(index, NaND); }
  ...
  public float optFloat(int index) { return optFloat(index, NaNF); }
  ...
  public <E extends Enum<E>> E optEnum(Class<E> clazz, int index) { return optEnum(clazz, index, null); }
  ...
  public Number optNumber(int index) { return optNumber(index, null); }
  ...
  public List<Object> toList() {
    ...
    for (Object element : this.myArrayList) {
      if (element == null || JSONObject.NULL.equals(element)) {
        ...
        results.add(((JSONArray)element).toList()); continue;
      }  if (element instanceof JSONObject) {
        results.add(((JSONObject)element).toMap()); continue;
      } 
      results.add(element);
    } 
