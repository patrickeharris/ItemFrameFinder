...
public class NBTTagList
  ...
  public NBTBase removeTag(int p_74744_1_) { return this.tagList.remove(p_74744_1_); }
  ...
  public int[] func_150306_c(int p_150306_1_) {
    if (p_150306_1_ >= 0 && p_150306_1_ < this.tagList.size()) {
      ...
      NBTBase nbtbase = this.tagList.get(p_150306_1_);
  ...
  public double func_150309_d(int p_150309_1_) {
    if (p_150309_1_ >= 0 && p_150309_1_ < this.tagList.size()) {
      ...
      NBTBase nbtbase = this.tagList.get(p_150309_1_);
  ...
  public float func_150308_e(int p_150308_1_) {
    if (p_150308_1_ >= 0 && p_150308_1_ < this.tagList.size()) {
      ...
      NBTBase nbtbase = this.tagList.get(p_150308_1_);
  ...
  public String getStringTagAt(int p_150307_1_) {
    if (p_150307_1_ >= 0 && p_150307_1_ < this.tagList.size()) {
      ...
      NBTBase nbtbase = this.tagList.get(p_150307_1_);
  ...
  public int hashCode() { return super.hashCode() ^ this.tagList.hashCode(); }



  
  public int func_150303_d() { return this.tagType; }
}
