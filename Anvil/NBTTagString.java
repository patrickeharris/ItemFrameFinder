  ...
  extends NBTBase
{
  ...
  void write(DataOutput p_74734_1_) throws IOException { p_74734_1_.writeUTF(this.data); }
  ...
  public NBTBase copy() { return new NBTTagString(this.data); }
  ...
  public int hashCode() { return super.hashCode() ^ this.data.hashCode(); }



  
  public String func_150285_a_() { return this.data; }
}
